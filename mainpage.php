...
<html lang="en">
    ...
    <form method="post" class="form-group" id="kayitForm">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <input type="text" name="cikis" class="form-control" placeholder="Çıkış" id="cikis">
                </div>
                <div class="col-md-6">
                    <input type="text" name="cözüm" class="form-control" placeholder="Çözüm" id="cözüm">
                </div>
                <div class="col-md-6">
                    <input type="text" name="yapilis" class="form-control" placeholder="Yapılış" id="yapilis">
                </div>
                <div class="col-md-6">
                    <input type="text" name="yapan" class="form-control" placeholder="Yapan" id="yapan">
                </div>
                <div class="col-md-6">
                    <input type="text" name="fiyat" class="form-control" placeholder="Fiyat" id="fiyat">
                </div>
                <div class="col-md-6">
                    <input type="text" name="teslimAlan" class="form-control" placeholder="Teslim Alan" id="teslimAlan">
                </div>
            </div>
        </div>
